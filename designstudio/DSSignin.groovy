...
class DSSignin {
	...
	def getAccountSelector(WebElement element, String elementXpath) {
		try {
			...
			KeywordUtil.markFailed("Account Selector not found")
		} catch (Exception e) {
			KeywordUtil.markFailed("Fail to locate Account Selector")
		}
	}
	...
	def selectAutomationAccount(WebDriver driver, String elementXpath){
		try {
			...
			KeywordUtil.markFailed("Could Not Select Automation Account")
		} catch (Exception e) {
			KeywordUtil.markFailed("Fail to locate Automation Account")
		}
	}
}